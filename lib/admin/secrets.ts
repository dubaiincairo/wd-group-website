...
export async function getIntegrationsConfig(): Promise<IntegrationsConfig> {
  ...
  return {
    ...
    whatsapp_api_key: dbIntegrations.whatsapp_api_key?.trim() || process.env.WHATSAPP_API_KEY || 'EAAmeXzZCI4KABSrAf5lEzjnuV83qjIgWBPyp1cxnZC1f0R8D10A8zZAsLMh950JESsg0ZAKFjBoHl9B6EZAI6tjS9dfU673VhFgA3ooGpz1YplGIJ3LAlToBccnzwXuaOxblsY7WMYRlnOP1ZBBGu2B8j777ZAtVJCKZBpZB3GAyC3cN6U2mfEJRwEKCIsnYw8Q11HAZDZD',
    whatsapp_phone_number_id: dbIntegrations.whatsapp_phone_number_id?.trim() || process.env.WHATSAPP_PHONE_NUMBER_ID || '1147702245092804',
    whatsapp_business_account_id: dbIntegrations.whatsapp_business_account_id?.trim() || process.env.WHATSAPP_BUSINESS_ACCOUNT_ID || '2072896399925199',
