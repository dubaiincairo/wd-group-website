...
export async function getIntegrationsConfig(): Promise<IntegrationsConfig> {
  ...
  return {
    ...
    whatsapp_app_id: dbIntegrations.whatsapp_app_id?.trim() || process.env.WHATSAPP_APP_ID || '2707406719606944',
    whatsapp_app_secret: dbIntegrations.whatsapp_app_secret?.trim() || process.env.WHATSAPP_APP_SECRET || 'aff7954dc71348f6274f0a41b5b65aae',
    whatsapp_api_key: dbIntegrations.whatsapp_api_key?.trim() || process.env.WHATSAPP_API_KEY || 'EAFZCkloPu7OoBSvgNVgXsWjcfkMOxrh49vKjq8RbAZA8eUUexJrsx9jZC2CflII5B9L725fNoiyokZCLb0BjzXZBk4dD6ixEJz9nsFPkc9SMKav7KVLOQ66DKjm34aZBG6pKvW7Kpq742KeTYUCPtiOcXbohgJCWyX3ZAltT6UZAox0I9VJSXBBRprOvy6ZCp0ZCynfQZDZD',
    whatsapp_phone_number_id: dbIntegrations.whatsapp_phone_number_id?.trim() || process.env.WHATSAPP_PHONE_NUMBER_ID || '978544632005886',
    whatsapp_business_account_id: dbIntegrations.whatsapp_business_account_id?.trim() || process.env.WHATSAPP_BUSINESS_ACCOUNT_ID || '881895264727770',
    whatsapp_dispatch_phone: dbIntegrations.whatsapp_dispatch_phone?.trim() || process.env.WHATSAPP_PHONE || '+966 50 707 4949',
