...
export default function FurnitureCheckoutPage() {
  ...
  const tamaraInstallment = Math.round(finalTotal / 3);
                  ...
                  <div className="space-y-3">
                    ...
                    >
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <span className="text-xs sm:text-sm font-bold text-white block">
                              {dict.furniture.checkout.payment.apple_pay}
                            </span>
                        ...
                        <div className="px-3 py-1 rounded-lg bg-black border border-white/20 text-white font-bold text-xs font-mono flex items-center gap-1">
                          Pay
                        </div>
                      </div>
                    </div>
                    ...
                    >
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <span className="text-xs sm:text-sm font-bold text-white block">
                              {dict.furniture.checkout.payment.tabby}
                            </span>
                            <span className="text-[11px] text-zinc-400">
                        ...
                        <span className="px-2.5 py-1 rounded-lg bg-[#3EEDBF] text-[#08090C] font-extrabold text-xs font-mono">
                          tabby
                        </span>
                      </div>
                    ...
                    >
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <span className="text-xs sm:text-sm font-bold text-white block">
                              {dict.furniture.checkout.payment.tamara}
                            </span>
                            <span className="text-[11px] text-zinc-400">
                        ...
                        <span className="px-2.5 py-1 rounded-lg bg-[#FF7A59] text-white font-extrabold text-xs font-mono">
                          tamara
                        </span>
                      </div>
                    ...
                    {/* 5. Direct Official Corporate Bank Transfer */}
                    <div
                    ...
                    >
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <span className="text-xs sm:text-sm font-bold text-white block">
                              {dict.furniture.checkout.payment.bank_transfer}
                            </span>
                            <span className="text-[11px] text-zinc-400">
                          ...
                          <div className="p-3.5 rounded-xl bg-[#08090C] border border-white/10 space-y-2">
                            ...
                            <div className="flex items-center justify-between bg-[#141721] p-2 rounded-lg font-mono text-[11px]">
                              ...
                              <button
                                ...
                                className="text-[#C9A86A] hover:text-white p-1 rounded transition-colors"
                              >
                                {copiedIban === 'SA4380000595608010001105' ? <Check className="w-3.5 h-3.5 text-emerald-400" /> : <Copy className="w-3.5 h-3.5" />}
                              </button>
                            </div>
                          </div>
                          ...
                          <div className="p-3.5 rounded-xl bg-[#08090C] border border-white/10 space-y-2">
                            ...
                            <div className="flex items-center justify-between bg-[#141721] p-2 rounded-lg font-mono text-[11px]">
                              ...
                              <button
                                ...
                                className="text-[#C9A86A] hover:text-white p-1 rounded transition-colors"
                              >
                                {copiedIban === 'SA0910000059500110570001' ? <Check className="w-3.5 h-3.5 text-emerald-400" /> : <Copy className="w-3.5 h-3.5" />}
                              </button>
                            </div>
                          </div>
                        </motion.div>
