...
Return ONLY valid JSON matching this schema:
{
  ...
  "seoFocusKeyword": "string"
    ...
    const simulatedData = {
      ...
      fullDescEn: 'Crafted at Green Wood Factory in Riyadh utilizing 5-axis CNC precision joinery, reinforced with internal mortise-and-tenon joints, and coated with non-yellowing polyurethane luxury matte lacquer.',
      fullDescAr: 'صنعت في مصنع الأخشاب الخضراء بالرياض بتقنية ماكينات الـ CNC خماسية المحاور مع تعشيق الشق واللسان ومحمية بدهان بولي يوريثان إيطالي مطفي مقاوم للاصفرار.',
