...
export default function EmailTemplatesAdminPage() {
  ...
  const templates: EmailTemplateMeta[] = [
    {
      ...
      subjectAr: 'شكراً لتواصلك مع مجموعة دبليو دي للأعمال [Ref: WD-INQ-849201]',
    ...
    },
    {
      ...
      subjectAr: '🚨 [New Lead] Eng. Sultan Al-Otaibi · MANUFACTURING',
      ...
      iframeDoc: `<!DOCTYPE html><html><head><meta charset="utf-8"><style>body{margin:0;padding:20px;background:#08090C;color:#E4E4E7;font-family:-apple-system,sans-serif;}</style></head><body><div style="max-width:600px;margin:0 auto;background:#0F1117;border:1px solid #232733;border-radius:20px;overflow:hidden;"><div style="height:4px;background:linear-gradient(90deg,#3B82F6,#2563EB,#60A5FA);"></div><div style="padding:32px 24px;text-align:center;background:#141722;border-bottom:1px solid #1F2430;"><h1 style="margin:0;color:#FFF;font-size:22px;letter-spacing:1px;">WD GROUP</h1><p style="margin:4px 0 0;color:#60A5FA;font-size:10px;text-transform:uppercase;letter-spacing:1.5px;font-family:monospace;">Commercial CRM & Enterprise Leads</p></div><div style="padding:32px 24px;line-height:1.65;font-size:14px;"><span style="display:inline-block;padding:3px 10px;border-radius:100px;font-size:10px;font-weight:bold;background:rgba(37,99,235,0.15);color:#60A5FA;border:1px solid rgba(37,99,235,0.3);margin-bottom:14px;text-transform:uppercase;font-family:monospace;">CRM Lead Dispatch</span><h2 style="margin:0 0 16px;color:#FFF;font-size:18px;">New Commercial Inquiry Received</h2><p style="margin-top:0;">A high-priority commercial inquiry has just been submitted via the <strong>WD Group Portal</strong>:</p><div style="background:#141722;border:1px solid #232733;border-left:4px solid #3B82F6;border-radius:12px;padding:16px;margin:20px 0;"><p style="margin:4px 0;font-size:13px;color:#A1A1AA;"><strong style="color:#FFF;">Client Name:</strong> <span style="color:#FFF;font-weight:bold;">Eng. Sultan Al-Otaibi</span></p><p style="margin:4px 0;font-size:13px;color:#A1A1AA;"><strong style="color:#FFF;">Email:</strong> <span style="color:#60A5FA;">sultan@otaibigroup.sa</span></p><p style="margin:4px 0;font-size:13px;color:#A1A1AA;"><strong style="color:#FFF;">Phone:</strong> <span style="color:#34D399;">+966 50 123 4567</span></p><p style="margin:4px 0;font-size:13px;color:#A1A1AA;"><strong style="color:#FFF;">Company:</strong> Al-Otaibi Developments</p><p style="margin:4px 0;font-size:13px;color:#A1A1AA;"><strong style="color:#FFF;">Target Sector:</strong> <span style="color:#E3C58A;font-weight:bold;">MANUFACTURING</span></p><div style="margin-top:10px;padding-top:8px;border-top:1px solid rgba(255,255,255,0.06);color:#F4F4F5;font-size:12px;background:#0B0D14;padding:10px;border-radius:6px;">"We are developing a 120-key boutique hotel in Riyadh and require high-spec custom millwork and joinery."</div></div><div style="text-align:center;margin:28px 0;"><a href="https://wdgroup.online/admin/crm/inquiries" target="_blank" style="display:inline-block;padding:12px 30px;background:linear-gradient(135deg,#3B82F6,#2563EB);color:#FFF;text-decoration:none;font-weight:bold;border-radius:10px;font-size:12px;text-transform:uppercase;">Open in Admin Console CRM &rarr;</a></div></div><div style="padding:20px;background:#08090C;border-top:1px solid #1A1E27;text-align:center;font-size:10px;color:#71717A;">WD Group © 2026 · Riyadh · Jeddah · Najran · Kingdom of Saudi Arabia</div></div></body></html>`,
    },
    {
      id: 'career-candidate',
      ...
      subjectAr: 'Application Received: Senior Interior Architect [Ref: WD-APP-592814]',
      ...
      iframeDoc: `<!DOCTYPE html><html><head><meta charset="utf-8"><style>body{margin:0;padding:20px;background:#08090C;color:#E4E4E7;font-family:-apple-system,sans-serif;}</style></head><body><div style="max-width:600px;margin:0 auto;background:#0F1117;border:1px solid #232733;border-radius:20px;overflow:hidden;"><div style="height:4px;background:linear-gradient(90deg,#10B981,#059669,#34D399);"></div><div style="padding:32px 24px;text-align:center;background:#141722;border-bottom:1px solid #1F2430;"><h1 style="margin:0;color:#FFF;font-size:22px;letter-spacing:1px;">WD GROUP</h1><p style="margin:4px 0 0;color:#34D399;font-size:10px;text-transform:uppercase;letter-spacing:1.5px;font-family:monospace;">Human Capital & Talent Acquisition</p></div><div style="padding:32px 24px;line-height:1.65;font-size:14px;"><span style="display:inline-block;padding:3px 10px;border-radius:100px;font-size:10px;font-weight:bold;background:rgba(16,185,129,0.15);color:#34D399;border:1px solid rgba(16,185,129,0.3);margin-bottom:14px;text-transform:uppercase;font-family:monospace;">Human Capital & Careers</span><h2 style="margin:0 0 16px;color:#FFF;font-size:18px;">Your Application Has Been Received</h2><p style="margin-top:0;">Dear <strong>Fahad Al-Husseini</strong>,</p><p>Thank you for applying to <strong>WD Group</strong> for the position of <strong style="color:#60A5FA;">Senior Interior Architect</strong>.</p><div style="background:#141722;border:1px solid #232733;border-left:4px solid #10B981;border-radius:12px;padding:16px;margin:20px 0;"><p style="margin:0 0 6px;font-size:10px;color:#34D399;font-weight:bold;font-family:monospace;">APPLICATION ID: WD-APP-592814</p><p style="margin:4px 0;font-size:13px;color:#A1A1AA;"><strong style="color:#FFF;">Role:</strong> Senior Interior Architect</p><p style="margin:4px 0;font-size:13px;color:#A1A1AA;"><strong style="color:#FFF;">Status:</strong> <span style="color:#34D399;font-weight:bold;">Under Human Capital Review</span></p></div><p>Our Talent Acquisition team is reviewing your profile and will contact you if your qualifications match our active openings.</p><div style="text-align:center;margin:28px 0;"><a href="https://wdgroup.online/about" target="_blank" style="display:inline-block;padding:12px 30px;background:linear-gradient(135deg,#E3C58A,#C9A86A);color:#08090C;text-decoration:none;font-weight:bold;border-radius:10px;font-size:12px;text-transform:uppercase;">Discover WD Group Vision &rarr;</a></div><p style="margin-top:24px;font-size:12px;color:#A1A1AA;">Best regards,<br><strong style="color:#FFF;">WD Group Human Capital</strong></p></div><div style="padding:20px;background:#08090C;border-top:1px solid #1A1E27;text-align:center;font-size:10px;color:#71717A;">WD Group © 2026 · Riyadh · Jeddah · Najran · Kingdom of Saudi Arabia</div></div></body></html>`,
    },
    {
      id: 'hr-ats',
      ...
      subjectAr: '📄 [New Application] Fahad Al-Husseini · Senior Interior Architect',
      ...
      iframeDoc: `<!DOCTYPE html><html><head><meta charset="utf-8"><style>body{margin:0;padding:20px;background:#08090C;color:#E4E4E7;font-family:-apple-system,sans-serif;}</style></head><body><div style="max-width:600px;margin:0 auto;background:#0F1117;border:1px solid #232733;border-radius:20px;overflow:hidden;"><div style="height:4px;background:linear-gradient(90deg,#10B981,#059669,#34D399);"></div><div style="padding:32px 24px;text-align:center;background:#141722;border-bottom:1px solid #1F2430;"><h1 style="margin:0;color:#FFF;font-size:22px;letter-spacing:1px;">WD GROUP</h1><p style="margin:4px 0 0;color:#34D399;font-size:10px;text-transform:uppercase;letter-spacing:1.5px;font-family:monospace;">Human Capital & ATS Management</p></div><div style="padding:32px 24px;line-height:1.65;font-size:14px;"><span style="display:inline-block;padding:3px 10px;border-radius:100px;font-size:10px;font-weight:bold;background:rgba(16,185,129,0.15);color:#34D399;border:1px solid rgba(16,185,129,0.3);margin-bottom:14px;text-transform:uppercase;font-family:monospace;">Talent Acquisition Alert</span><h2 style="margin:0 0 16px;color:#FFF;font-size:18px;">New Candidate Profile in Talent Pool</h2><p style="margin-top:0;">A new candidate has submitted their credentials to the <strong>WD Group Talent Acquisition Portal</strong>:</p><div style="background:#141722;border:1px solid #232733;border-left:4px solid #10B981;border-radius:12px;padding:16px;margin:20px 0;"><p style="margin:4px 0;font-size:13px;color:#A1A1AA;"><strong style="color:#FFF;">Name:</strong> <span style="color:#FFF;font-weight:bold;">Fahad Al-Husseini</span></p><p style="margin:4px 0;font-size:13px;color:#A1A1AA;"><strong style="color:#FFF;">Position:</strong> <span style="color:#60A5FA;font-weight:bold;">Senior Interior Architect</span></p><p style="margin:4px 0;font-size:13px;color:#A1A1AA;"><strong style="color:#FFF;">Email:</strong> fahad@architecture.sa</p><p style="margin:4px 0;font-size:13px;color:#A1A1AA;"><strong style="color:#FFF;">Phone:</strong> +966 55 123 4567</p><p style="margin:4px 0;font-size:13px;color:#A1A1AA;"><strong style="color:#FFF;">Location:</strong> Riyadh, Saudi Arabia</p><div style="margin-top:12px;"><a href="#" style="display:inline-block;padding:8px 16px;background:rgba(16,185,129,0.15);border:1px solid rgba(16,185,129,0.3);color:#34D399;text-decoration:none;font-weight:bold;font-size:12px;border-radius:6px;">📄 Download Candidate Resume / CV &rarr;</a></div></div><div style="text-align:center;margin:28px 0;"><a href="https://wdgroup.online/admin/hr/applications" target="_blank" style="display:inline-block;padding:12px 30px;background:linear-gradient(135deg,#10B981,#059669);color:#FFF;text-decoration:none;font-weight:bold;border-radius:10px;font-size:12px;text-transform:uppercase;">Open Candidate in ATS Console &rarr;</a></div></div><div style="padding:20px;background:#08090C;border-top:1px solid #1A1E27;text-align:center;font-size:10px;color:#71717A;">WD Group © 2026 · Riyadh · Jeddah · Najran · Kingdom of Saudi Arabia</div></div></body></html>`,
    },
    {
      id: 'admin-reset',
      ...
      subjectAr: '🔐 Reset Your WD Group Admin Console Password',
      ...
      iframeDoc: `<!DOCTYPE html><html><head><meta charset="utf-8"><style>body{margin:0;padding:20px;background:#08090C;color:#E4E4E7;font-family:-apple-system,sans-serif;}</style></head><body><div style="max-width:600px;margin:0 auto;background:#0F1117;border:1px solid #232733;border-radius:20px;overflow:hidden;"><div style="height:4px;background:linear-gradient(90deg,#F59E0B,#D97706,#FBBF24);"></div><div style="padding:32px 24px;text-align:center;background:#141722;border-bottom:1px solid #1F2430;"><h1 style="margin:0;color:#FFF;font-size:22px;letter-spacing:1px;">WD GROUP</h1><p style="margin:4px 0 0;color:#FBBF24;font-size:10px;text-transform:uppercase;letter-spacing:1.5px;font-family:monospace;">Security & Console Access Control</p></div><div style="padding:32px 24px;line-height:1.65;font-size:14px;"><span style="display:inline-block;padding:3px 10px;border-radius:100px;font-size:10px;font-weight:bold;background:rgba(245,158,11,0.15);color:#FBBF24;border:1px solid rgba(245,158,11,0.3);margin-bottom:14px;text-transform:uppercase;font-family:monospace;">Security & Access Control</span><h2 style="margin:0 0 16px;color:#FFF;font-size:18px;">Admin Password Reset Request</h2><p style="margin-top:0;">Hello <strong>Mohammed Ali Al-Shaibani</strong>,</p><p>A password reset request was initiated for your <strong>WD Group Executive Admin Console</strong> account (<code style="background:rgba(255,255,255,0.1);padding:2px 6px;border-radius:4px;color:#E3C58A;font-family:monospace;">ceo@wdgroup.online</code>).</p><div style="background:#141722;border:1px solid #232733;border-left:4px solid #C9A86A;border-radius:12px;padding:16px;margin:20px 0;"><p style="margin:0 0 6px;font-size:13px;color:#E4E4E7;font-weight:bold;">🔐 Secure Reset Link Details:</p><ul style="margin:0;padding-left:18px;font-size:12px;color:#A1A1AA;line-height:1.6;"><li>This link is single-use and will automatically expire in <strong>60 minutes</strong>.</li><li>If you did not make this request, your account remains secure.</li></ul></div><div style="text-align:center;margin:28px 0;"><a href="#" target="_blank" style="display:inline-block;padding:12px 30px;background:linear-gradient(135deg,#E3C58A,#C9A86A);color:#08090C;text-decoration:none;font-weight:bold;border-radius:10px;font-size:12px;text-transform:uppercase;">Reset Admin Password &rarr;</a></div></div><div style="padding:20px;background:#08090C;border-top:1px solid #1A1E27;text-align:center;font-size:10px;color:#71717A;">WD Group © 2026 · Riyadh · Jeddah · Najran · Kingdom of Saudi Arabia</div></div></body></html>`,
    },
    {
      id: 'magic-link',
      ...
      subjectAr: '✨ 1-Click Sign In: WD Group Admin Console',
      ...
      iframeDoc: `<!DOCTYPE html><html><head><meta charset="utf-8"><style>body{margin:0;padding:20px;background:#08090C;color:#E4E4E7;font-family:-apple-system,sans-serif;}</style></head><body><div style="max-width:600px;margin:0 auto;background:#0F1117;border:1px solid #232733;border-radius:20px;overflow:hidden;"><div style="height:4px;background:linear-gradient(90deg,#3B82F6,#2563EB,#60A5FA);"></div><div style="padding:32px 24px;text-align:center;background:#141722;border-bottom:1px solid #1F2430;"><h1 style="margin:0;color:#FFF;font-size:22px;letter-spacing:1px;">WD GROUP</h1><p style="margin:4px 0 0;color:#60A5FA;font-size:10px;text-transform:uppercase;letter-spacing:1.5px;font-family:monospace;">Instant Executive Console Access</p></div><div style="padding:32px 24px;line-height:1.65;font-size:14px;"><span style="display:inline-block;padding:3px 10px;border-radius:100px;font-size:10px;font-weight:bold;background:rgba(37,99,235,0.15);color:#60A5FA;border:1px solid rgba(37,99,235,0.3);margin-bottom:14px;text-transform:uppercase;font-family:monospace;">Instant Authentication</span><h2 style="margin:0 0 16px;color:#FFF;font-size:18px;">1-Click Executive Console Access</h2><p style="margin-top:0;">Hello <strong>Mohammed Ali Al-Shaibani</strong>,</p><p>You requested a 1-click passwordless sign-in for your <strong>WD Group Executive Console</strong> (<code style="background:rgba(255,255,255,0.1);padding:2px 6px;border-radius:4px;color:#60A5FA;font-family:monospace;">ceo@wdgroup.online</code>).</p><div style="background:#141722;border:1px solid #232733;border-left:4px solid #2563EB;border-radius:12px;padding:16px;margin:20px 0;"><p style="margin:0;font-size:13px;color:#93C5FD;line-height:1.5;">⚡ <strong>Instant Authentication:</strong> Click below to sign in immediately. Valid for <strong>15 minutes</strong>.</p></div><div style="text-align:center;margin:28px 0;"><a href="#" target="_blank" style="display:inline-block;padding:12px 30px;background:linear-gradient(135deg,#3B82F6,#2563EB);color:#FFF;text-decoration:none;font-weight:bold;border-radius:10px;font-size:12px;text-transform:uppercase;">Sign In to Admin Console &rarr;</a></div></div><div style="padding:20px;background:#08090C;border-top:1px solid #1A1E27;text-align:center;font-size:10px;color:#71717A;">WD Group © 2026 · Riyadh · Jeddah · Najran · Kingdom of Saudi Arabia</div></div></body></html>`,
    },
    {
      id: 'furniture-order',
      ...
      iframeDoc: `<!DOCTYPE html><html><head><meta charset="utf-8"><style>body{margin:0;padding:20px;background:#08090C;color:#E4E4E7;font-family:-apple-system,sans-serif;direction:rtl;text-align:right;}</style></head><body><div style="max-width:600px;margin:0 auto;background:#0F1117;border:1px solid #232733;border-radius:20px;overflow:hidden;"><div style="height:4px;background:linear-gradient(90deg,#E3C58A,#C9A86A,#2563EB,#E3C58A);"></div><div style="padding:32px 24px;text-align:center;background:#141722;border-bottom:1px solid #1F2430;"><h1 style="margin:0;color:#FFF;font-size:22px;">مجموعة دبليو دي للأعمال</h1><p style="margin:4px 0 0;color:#C9A86A;font-size:11px;font-weight:bold;">قطاع تصنيع الأثاث والمفروشات الفندقية</p></div><div style="padding:32px 24px;line-height:1.65;font-size:14px;"><span style="display:inline-block;padding:3px 10px;border-radius:100px;font-size:10px;font-weight:bold;background:rgba(201,168,106,0.15);color:#E3C58A;border:1px solid rgba(201,168,106,0.3);margin-bottom:14px;">تأكيد الطلب والفاتورة</span><h2 style="margin:0 0 16px;color:#FFF;font-size:18px;">تم تأكيد استلام طلبك بنجاح</h2><p style="margin-top:0;">مرحباً <strong>عبدالله الفولي</strong>،</p><p>شكراً لتسوقك من <strong>مجموعة دبليو دي — قطاع تصنيع الأثاث</strong>. تم تأكيد طلبك وجارٍ تجهيزه للتسليم.</p><div style="background:#141722;border:1px solid #232733;border-right:4px solid #C9A86A;border-radius:12px;padding:16px;margin:20px 0;"><table width="100%" style="border-collapse:collapse;"><tr><td colspan="2" style="padding-bottom:8px;border-bottom:1px solid rgba(255,255,255,0.08);font-size:11px;color:#C9A86A;font-weight:bold;font-family:monospace;">رقم الطلب: WD-ORD-2026-8819</td></tr><tr><td style="padding:10px 0;border-bottom:1px solid rgba(255,255,255,0.06);font-size:13px;color:#FFF;"><strong>طقم كنب الضيافة الملكي</strong><br><span style="font-size:11px;color:#A1A1AA;">الكمية: 1</span></td><td align="left" style="font-size:13px;font-weight:bold;color:#E3C58A;font-family:monospace;">14,500 ر.س</td></tr><tr><td style="padding:10px 0;border-bottom:1px solid rgba(255,255,255,0.06);font-size:13px;color:#FFF;"><strong>طاولة طعام خشب الجوز الفاخر</strong><br><span style="font-size:11px;color:#A1A1AA;">الكمية: 1</span></td><td align="left" style="font-size:13px;font-weight:bold;color:#E3C58A;font-family:monospace;">8,200 ر.س</td></tr><tr><td style="padding-top:12px;font-size:14px;font-weight:bold;color:#FFF;">الإجمالي النهائي (شامل الضريبة 15%):</td><td align="left" style="padding-top:12px;font-size:16px;font-weight:bold;color:#E3C58A;font-family:monospace;">22,700 ر.س</td></tr></table></div><div style="text-align:center;margin:28px 0;"><a href="https://wdgroup.online/furniture" target="_blank" style="display:inline-block;padding:12px 30px;background:linear-gradient(135deg,#E3C58A,#C9A86A);color:#08090C;text-decoration:none;font-weight:bold;border-radius:10px;font-size:12px;">متابعة الطلب والمحادثة &larr;</a></div></div><div style="padding:20px;background:#08090C;border-top:1px solid #1A1E27;text-align:center;font-size:10px;color:#71717A;">مجموعة دبليو دي للأعمال © 2026 · المملكة العربية السعودية</div></div></body></html>`,
    },
  ];
  ...
  const handleCopyHtml = () => {
    navigator.clipboard.writeText(currentTemplate.iframeDoc);
    showToast(isAr ? 'تم نسخ كود الـ HTML بنجاح إلى الحافظة!' : 'Email HTML copied to clipboard!', 'success');
  };
  ...
  const handleSendTestEmail = async (e: React.FormEvent) => {
    ...
    try {
      ...
      showToast(
        isAr ? `تم إرسال نموذج البريد بنجاح إلى ${testEmail}!` : `Test email dispatched successfully to ${testEmail}!`,
        'success'
      );
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-white/10 pb-6">
        <div>
          ...
          <p className="text-xs sm:text-sm text-zinc-400 mt-1">
            {isAr ? 'استعراض واختبار وتصدير كافة رسائل البريد الإلكتروني التلقائية المعتمدة لمجموعة دبليو دي.' : 'Review, test, and export all 7 branded transactional email templates for WD Group.'}
          </p>
        </div>
        ...
        <div className="flex flex-wrap items-center gap-2.5">
          ...
          >
            ...
            <span>{isAr ? 'إرسال بريد تجريبي حقيقي' : 'Send Live Test Email'}</span>
          </button>
        ...
        <div className="lg:col-span-4 space-y-3">
          <div className="flex items-center justify-between px-2">
            <span className="text-xs font-mono font-bold text-[#C9A86A] uppercase tracking-wider">
              {isAr ? 'القوالب المعتمدة (7 قوالب)' : 'TEMPLATES (7 TOTAL)'}
            </span>
          ...
          <div className="bg-[#0F1117] border border-white/10 rounded-2xl p-5 space-y-3">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs">
              <div className="p-2.5 rounded-xl bg-black/40 border border-white/5">
                <span className="text-[10px] font-mono text-zinc-500 uppercase block mb-0.5">{isAr ? 'عنوان الرسالة (Subject Line)' : 'Subject Line'}</span>
                <span className="text-white font-mono text-xs">{isAr ? currentTemplate.subjectAr : currentTemplate.subjectEn}</span>
              </div>
              <div className="p-2.5 rounded-xl bg-black/40 border border-white/5">
          ...
          <div className="flex items-center justify-between bg-[#0F1117] border border-white/10 rounded-2xl p-3 px-4">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs font-mono text-zinc-400">
                {viewMode === 'desktop' ? 'Desktop Viewport (600px width)' : viewMode === 'tablet' ? 'Tablet Viewport (520px width)' : 'Mobile Viewport (375px width)'}
              </span>
            </div>
          ...
          <div className="bg-[#08090C] border border-white/10 rounded-3xl p-4 sm:p-6 flex justify-center items-center overflow-hidden min-h-[640px]">
            {viewSource ? (
              <div className="w-full bg-[#0B0D14] border border-white/10 rounded-2xl p-4 overflow-x-auto max-h-[620px] text-xs font-mono text-zinc-300">
                <pre className="whitespace-pre-wrap">{currentTemplate.iframeDoc}</pre>
              </div>
            ) : (
              <div 
              ...
              >
                <iframe
                  key={`${currentTemplate.id}-${viewMode}`}
                  srcDoc={currentTemplate.iframeDoc}
        ...
        <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-sm flex items-center justify-center p-4">
          <div className="bg-[#0F1117] border border-white/15 rounded-3xl max-w-md w-full p-6 space-y-5 shadow-2xl animate-in zoom-in-95 duration-200">
            ...
            <form onSubmit={handleSendTestEmail} className="space-y-4">
              <div className="p-3.5 rounded-xl bg-[#141722] border border-white/10 space-y-1">
                <span className="text-[10px] font-mono text-zinc-500 uppercase">{isAr ? 'القالب المحدد للإرسال:' : 'Selected Template:'}</span>
